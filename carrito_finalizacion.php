<?php require_once('Connections/conexiontienda.php'); ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<title>Finalizacion de la Compra</title>
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="EditRegion3" -->
  <div class="contenido">
    <?php if ($_POST["radio"] == 1)
	  ...
	  ?>
    <center><h1 >Compra realizada con éxito.</h1></center>
    <span style="text-justify:">
                <h2>Una vez realizado y comprobado el depósito bancario , en un transcurso de 24  a 48 horas (dias laborables), se procederá a enviar el pedido.</h2>
                <h2>Por favor revise &quot;<em>Ver Mis compras</em>&quot;
                  en nuestra página web para ver el estado de su pedido. 
Para ello inicie sesion con sus datos.  </h2></span>
                <p>Un cordial saludo.
