...
<!-- InstanceBeginEditable name="EditRegion3" -->
  <div class="contenido">
    ...
    <div class="nombre-categoria">Resultado de la Búsqueda</div>
...
<?php } // Show if recordset empty ?>
  ...
  <div class="producto">
    ...
    <div class="descripcion-producto"><?php echo $row_DatosProductos['strDescripcion']; ?><br />
...
if  ($row_DatosProductos['intStock'] >0)
{
    ...
    <div class="precio-producto"><?php echo $row_DatosProductos['dbPrecio']; ?> Bs</div>
    <div class="boton-comprar"><a href="producto_detalle.php?recordID=<?php echo $row_DatosProductos['idProducto']; ?>"><img src="detalles.png" width="190" height="30" /></a></div>
