...
<!-- InstanceBeginEditable name="EditRegion3" -->
  <div class="contenido"><div class="contenido">
    <center>
      <h1><strong>DEPOSITO EN CUENTA BANCARIA</strong></h1>
    </center>
    <h4>Una vez que haya realizado el depósito tiene que escanear su boleta de pago, y proceder a </h4>
    <h4>enviarla a nuestro correo electrónico: <em><strong><span class="correoelectronico">josecarlosanezsuarez@gmail.com</span></strong></em></h4>
    <h4>Inmediatamente después de verificar sus datos, procederemos a enviar su pedido.</h4>
    <div class="logo-bnb"><center>
      <img src="bancoeconomico.png" width="300" height="200" />
    </center></div>
   
    <br />
<center>Cuenta en Bolivianos (Bs)</center>
<p>* Por favor cuando vaya a depositar el dinero de su pedido, enviarlo con el concepto de : </p>
<p><strong><em>&quot;Compra por Internet TiendaOnline&quot;</em></strong><br />
</p>
<table width="356" border="0" align="center" cellpadding="4" cellspacing="4">
  <tr>
    <td width="44%" bgcolor="#FF3333"><p>Numero de cuenta:</p></td>
    <td width="56%" bgcolor="#FFFF66">1061-569716</td>
  </tr>
  <tr>
    <td bgcolor="#FF3333">Titular de la Cuenta:</td>
    <td bgcolor="#FFFF66">José Carlos Añez Suárez</td>
  </tr>
</table>
<CENTER>
<p>
   <form id="form1" name="form1" method="post" action="carrito_finalizacion.php">
    <p>
                  ...
                  <label for="radio">Depósito Bancario</label>
                  <br /></p>
        <form id="form1" name="form1" method="post" action="carrito_finalizacion.php">
